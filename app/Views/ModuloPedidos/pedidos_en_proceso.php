<!-- Content Wrapper. Contains page content -->
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h2 class="card-title"><b>Lista de pedidos en proceso</b></h2>
                <div class="d-grid d-md-flex  justify-content-md-end">
                  <div class="btn-group col-2" role="group">
                      <button id="btnGroupDrop1" type="button" class="btn dropdown-toggle form-control  bg-info" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        En proceso
                      </button>
  ...
  <script >
    ...
    function iniciar() {
      ...
      $(".entregado").click(pasar_a_entregado);   
    }
    ...
    function pasar_a_entregado(){
      ...
      $.ajax({
        url: '<?php echo base_url('/ModuloPedidos/PasarEntregado');?>',
        type: 'POST',
        dataType: 'text',
        data: {id: id},
      }).done(function(data) {
        ...
        if (data.trim()=="Ok") {
          ...
          alert("No se pudo pasar a 'entregado', el registro");
        }
